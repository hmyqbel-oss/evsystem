  ...
  return (
    <div className="p-4 md:p-6 space-y-6 max-w-7xl mx-auto">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <Card className="border-0 shadow-sm">
          <CardHeader>
            <CardTitle className="text-base">متوسط النتائج حسب المحور</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className="border-0 shadow-sm">
          <CardHeader>
            <CardTitle className="text-base">توزيع مستويات التقييم</CardTitle>
          </CardHeader>
        ...
        <Card className="border-0 shadow-sm">
          <CardHeader>
            <CardTitle className="text-base">نتائج المنظمات</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className="border-0 shadow-sm">
          <CardHeader>
            <CardTitle className="text-base">تحليل شامل - آخر تقييم</CardTitle>
          </CardHeader>
          <CardContent>
            <ResponsiveContainer width="100%" height={250}>
      ...
      <Card className="border-0 shadow-sm">
        <CardHeader>
          <CardTitle className="text-base">التقييمات الأخيرة</CardTitle>
        </CardHeader>
        <CardContent>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b">
                  <th className="text-right py-3 px-2 font-medium text-muted-foreground">المنظمة</th>
                  <th className="text-right py-3 px-2 font-medium text-muted-foreground">المُقيّم</th>
                ...
                {sampleEvaluations.map((ev) => {
                  ...
                  return (
                    <tr key={ev.id} className="border-b last:border-0 hover:bg-muted/50 transition-colors">
                      <td className="py-3 px-2 font-medium">{ev.organizationName}</td>
                      <td className="py-3 px-2 text-muted-foreground">{ev.evaluatorName}</td>
                      <td className="py-3 px-2 text-muted-foreground">{ev.date}</td>
